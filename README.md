...
[![npm](https://img.shields.io/npm/l/@powerm1nt/xmcl-core.svg)](https://github.com/voxelum/minecraft-launcher-core-node/blob/master/LICENSE)
...
| ----------------------- | ----------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- | ------------------- |
| @powerm1nt/xmcl-core              | Launch Minecraft                                                                          | [![npm version](https://img.shields.io/npm/v/@powerm1nt/xmcl-core.svg)](https://www.npmjs.com/package/@powerm1nt/xmcl-core)                           | [packages/core             ](/packages/core)              | Node                |
...
| @powerm1nt/xmcl-unzip             | yauzl unzip wrapper                                                                       | [![npm version](https://img.shields.io/npm/v/@powerm1nt/xmcl-unzip.svg)](https://www.npmjs.com/package/@powerm1nt/xmcl-unzip)                         | [packages/unzip            ](/packages/unzip)             | Node                |
